			...
			<div className="absolute z-50 m-auto flex w-[380px] flex-1 flex-col justify-center p-6 sm:w-[468px] sm:p-10">
				<Link href="/">
					<h1 className="flex flex-col items-center text-3xl">
						<Image className="active:scale-95" src={logo} width={50} height={50} alt={`${siteConfig.name} logo`} />
						<span className="mt-2 font-black text-gray-900">{siteConfig.name}</span>
					</h1>
				</Link>
				<p className="mb-6 mt-3 text-center text-sm font-medium text-zinc-600">Get started for free.</p>
				<SignUp />
			</div>
